...
public class Test {
    ...
    private static final String SQL_INSERT =  "INSERT INTO CUENTA (ID, NOMBRE, APELLIDO, MATRICULA) VALUES (?,?,?,?)";
    private static final String SQL_UPDATE =  "UPDATE ODONTOLOGO SET MATRICULA=? WHERE ID=?";

    public static void main(String[] args) throws Exception {
        Odontologo odontologo = new Odontologo("Francisco", "Suarez", "AB456789");
        ...
        try{
            ...
            psUpdate1.setString(1, odontologo.setMatricula("AC456789"));
            ...
            psUpdate2.setString(1, odontologo.setMatricula("AD456789"));
