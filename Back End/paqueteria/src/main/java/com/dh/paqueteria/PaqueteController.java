...
public class PaqueteController {
    ...
    public List<Paquete> entregado(){
        return paqueteService.paquetesEntregado();
    }

    @GetMapping("/por-recoger")
    public List<Paquete> porRecoger(){
        return paqueteService.paquetesPorRecoger();
    }
}
