...
public class PaqueteService {
    ...
    public List<Paquete> paquetesEntregado(){
        return paqueteRepository.findAllByEstado(Estado.ENTREGADO);
    }
    public List<Paquete> paquetesPorRecoger(){
        return paqueteRepository.findAllByEstado(Estado.POR_RECOGER);
    }
